...
export const deleteReview = (reviewID, productID) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.delete(`/api/reviews?reviewId=${reviewID}&productId=${productID}`);
